...
import com.example.app.dto.OtpRequest;
import com.example.app.dto.OtpVerificationRequest;
...
public class UserController {
    ...
    @PostMapping("/update")
    public ResponseEntity<UserResponse> updateUser(@RequestBody UserEntity user) {
