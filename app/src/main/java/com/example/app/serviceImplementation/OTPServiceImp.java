...
import com.example.app.repository.OtpRepo;
...
public class OTPServiceImp implements OTPService {
	...
	@Autowired
	private OtpRepo otpInfoRepository;
	...
	public String generateOTP(String accountNumber) {
		...
		OtpInfoEntity existingOtpInfo = otpInfoRepository.findByAccountNumber(accountNumber);
	...
	private String generateNewOTP(String accountNumber) {
		...
		OtpInfoEntity otpInfo = new OtpInfoEntity();
	...
	public boolean validateOTP(String accountNumber, String otp) {
		OtpInfoEntity otpInfo = otpInfoRepository.findByAccountNumberAndOtp(accountNumber, otp);
